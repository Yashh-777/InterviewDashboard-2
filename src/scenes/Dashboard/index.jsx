...
const Dashboard = (props) => {
  ...
  console.log("XVCVSGDVX");
  console.log(arrayOfMails);  // *******************************************
  console.log("XVCVSGDVX");

  

  // function predictCategories(contentArray) {
  //   // Load the trained model
  //   const model =  tf.loadLayersModel("../../model.js");
  ...
  //   contentArray.forEach((content) => {
  //     const xTest = extractFeatures(content);
  //     const prediction = model.predict(tf.tensor2d([xTest])).arraySync()[0];
  //     const categories = ["shortlisted", "selected", "rejected"];
  //     const predictedCategory =
  //       categories[prediction.indexOf(Math.max(...prediction))];

  //     // Increment the count for the predicted category
  //     if (predictedCategory === "shortlisted") {
  //       sCount++;
  //     } else if (predictedCategory === "selected") {
  //       selCount++;
  //     } else {
  //       rCount++;
  //     }
  ...
  // console.log("6t768687687");
  // predictCategories(arrayOfMails)
  // .then((count) => {
  //   console.log(count);
  // })
  // .catch((error) => {
  ...
  useEffect(() => {
    async function fetchData() {
      const { emailContent } = await readInboxContent(
        "from:grp14.project@gmail.com"
      );
    ...
    <Box m="20px">
      ...
      >
        ...
        >
          <StatBox
            title={
              numberOfMails != null && <p>Total mails - {numberOfMails}</p>
            }
            subtitle=""
            progress="0.75"
            increase=""
        ...
        >
          <StatBox
            title={<p>Total Accepted mails - {selectedCount1}</p>}
            subtitle=""
            progress="0.75"
            increase=""
            icon={
        ...
        >
          <StatBox
            title={<p>Total Shortlisted mails - {shortlistedCount1}</p>}
            subtitle=""
            progress="0.60"
            increase=""
            icon={
        ...
        >
          <StatBox
            title={<p>Total Rejected mails - {rejectedCount1}</p>}
            subtitle=""
            progress="0.30"
            increase=""
            icon={
        ...
        >
          <StatBox
            ...
            subtitle={emailContent != null && <p>{emailContent}</p>}
            progress=""
            increase=""
            icon={
              <EmailIcon
        ...
        {/* <div>
          {emailContent != null && <p>Content - {emailContent}</p>}
        </div> */}
      </Box>
    </Box>
  );
